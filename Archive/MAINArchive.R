...
#Test Area
  ...
  #WordClouds      
      ...
      wordcloud2(data=mtt_about, size=0.3, color='random-dark')
      wordcloud2(data=mtt_about2, size=0.3, color='random-dark')
      wordcloud2(data=mtt_about3, size=0.3, color='random-dark')
      wordcloud2(data=mtt_reviews, size=0.3, color='random-dark')
      wordcloud2(data=mtt_reviews2, size=0.3, color='random-dark')
      wordcloud2(data=mtt_reviews3, size=0.3, color='random-dark')
      wordcloud2(data=plq2g_about, size=0.3, color='random-dark')
      wordcloud2(data=plq2g_about2, size=0.3, color='random-dark')
      wordcloud2(data=plq2g_about3, size=0.3, color='random-dark')
      wordcloud2(data=plq2g_reviews, size=0.3, color='random-dark')
      wordcloud2(data=plq2g_reviews2, size=0.3, color='random-dark')
      wordcloud2(data=plq2g_reviews3, size=0.3, color='random-dark')
      wordcloud2(data=qt_about, size=0.3, color='random-dark')
      wordcloud2(data=qt_about2, size=0.3, color='random-dark')
      wordcloud2(data=qt_about3, size=0.3, color='random-dark')
      wordcloud2(data=qt_reviews, size=0.3, color='random-dark')
      wordcloud2(data=qt_reviews2, size=0.3, color='random-dark')
      wordcloud2(data=qt_reviews3, size=0.3, color='random-dark')
      wordcloud2(data=tc_about, size=0.3, color='random-dark')
      wordcloud2(data=tc_about2, size=0.3, color='random-dark')
      wordcloud2(data=tc_about3, size=0.3, color='random-dark')
      wordcloud2(data=tc_reviews, size=0.3, color='random-dark')
      wordcloud2(data=tc_reviews2, size=0.3, color='random-dark')
      wordcloud2(data=tc_reviews3, size=0.3, color='random-dark')
